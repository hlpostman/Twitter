...
//        let requestToken = BDBOAuthCredential(queryString: url.query)
...
//        twitterClient.fetchAccessToken(with: "oauth/access_token", method: "POST", requestToken: requestToken, success: { (accessToken:
